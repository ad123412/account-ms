 ...
 * Account used for billing or for settlement purposes concerning a given party (an organization or an individual).
 */
@ApiModel(description = "Account used for billing or for settlement purposes concerning a given party (an organization or an individual).")
@javax.annotation.Generated(value = "class io.swagger.codegen.languages.SpringCodegen", date = "2018-09-17T08:21:26.946+05:30")
@Document(indexName = "partyaccount", type = "account")
public class PartyAccount   {
  ...
  **/
  ...
  public PartyAccount lastModified(String lastModified) {
  ...
  **/
  ...
  public PartyAccount relatedParty(List<RelatedPartyRef> relatedParty) {
    this.relatedParty = relatedParty;
    return this;
  }

  public PartyAccount addRelatedPartyItem(RelatedPartyRef relatedPartyItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.baseType, partyAccount.baseType) &&
        ...
        Objects.equals(this.id, partyAccount.id) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(baseType, schemaLocation, type, creditLimit, description, href, id, lastModified, name, state, type, paymentStatus, billStructure, paymentPlan, financialAccount, defaultPaymentMethod, relatedParty, taxExemption, contact, accountBalance, accountRelationship);
  }
